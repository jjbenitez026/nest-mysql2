...
const nest_mysql2_client_module_1 = require("./nest-mysql2-client/nest-mysql2-client.module");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        const app = yield core_1.NestFactory.create(nest_mysql2_client_module_1.NestMysql2ClientModule);
